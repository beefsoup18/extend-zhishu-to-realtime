...
//    public static String boker_url = new String("192.168.1.101:9092,192.168.1.101:9091,192.168.1.101:9093");
    public static String second_boker_url = new String("localhost:9092");
...
//
//                /*创建zhishuhangqing Topic*/
//                NewTopic ZhiShuHangQingnewTopic = new NewTopic(Codes.code_talbe_names.get(i) + "_zhishuhangqing",
//                        1, rep_num);
//                CreateTopicsResult ZhiShuHangqingret = client0.createTopics(Arrays.asList(ZhiShuHangQingnewTopic));
//                ZhiShuHangqingret.all().get();
//                System.out.println(i + "th zhishuhangqing topic:" + Codes.code_talbe_names.get(i) + "_zhishuhangqing" + " created.");
//            } catch (Exception e){
//                e.printStackTrace();
//            }
//        }
